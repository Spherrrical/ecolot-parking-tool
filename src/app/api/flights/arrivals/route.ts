...
export async function GET(req: NextRequest, res: NextResponse) {
    ...
    const baseUrl = "https://www.portseattle.org/sea-tac/flight-status?flightNo=&flight_date=&airline=&page={}&arrive_city=&depart_city=&arr_or_depart=A&datetime_start=&datetime_end=&orderby=City";
